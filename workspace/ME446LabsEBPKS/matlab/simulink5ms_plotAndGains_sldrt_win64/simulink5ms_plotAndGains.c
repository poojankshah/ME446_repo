 ...
 * C source code generated on : Mon Apr 29 16:13:54 2024
 *
...
void simulink5ms_plotAndGains_output(void)
{
  ...
  /* Gain: '<Root>/plot1' */
  simulink5ms_plotAndGains_B.error1theta = simulink5ms_plotAndGains_P.plot1_Gain
    * simulink5ms_plotAndGains_B.Gain1;

  /* Outport: '<Root>/Out1' */
  simulink5ms_plotAndGains_Y.Out1 = simulink5ms_plotAndGains_B.error1theta;
  ...
  /* Gain: '<Root>/plot2' */
  simulink5ms_plotAndGains_B.error2theta = simulink5ms_plotAndGains_P.plot2_Gain
    * simulink5ms_plotAndGains_B.Gain2;

  /* Outport: '<Root>/Out2' */
  simulink5ms_plotAndGains_Y.Out2 = simulink5ms_plotAndGains_B.error2theta;
  ...
  /* Gain: '<Root>/plot3' */
  simulink5ms_plotAndGains_B.error3theta = simulink5ms_plotAndGains_P.plot3_Gain
    * simulink5ms_plotAndGains_B.Gain3;

  /* Outport: '<Root>/Out3' */
  simulink5ms_plotAndGains_Y.Out3 = simulink5ms_plotAndGains_B.error3theta;

  /* Gain: '<Root>/plot4' incorporates:
   *  DataTypeConversion: '<S1>/Data Type Conversion5'
   *  Gain: '<Root>/Gain4'
   */
  simulink5ms_plotAndGains_B.theta3_desired =
    simulink5ms_plotAndGains_P.Gain4_Gain * (real_T)
    simulink5ms_plotAndGains_B.PacketInput1_o1[3] *
    simulink5ms_plotAndGains_P.plot4_Gain;

  /* Outport: '<Root>/Out4' */
  simulink5ms_plotAndGains_Y.Out4 = simulink5ms_plotAndGains_B.theta3_desired;

  /* ToAsyncQueueBlock generated from: '<Root>/plot1' */
  {
    {
      double time = simulink5ms_plotAndGains_M->Timing.t[0];
      void *pData = (void *)&simulink5ms_plotAndGains_B.error1theta;
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(3533123197U, time, pData, size);
    }
  }
  ...
  /* ToAsyncQueueBlock generated from: '<Root>/plot2' */
  {
    {
      double time = simulink5ms_plotAndGains_M->Timing.t[0];
      void *pData = (void *)&simulink5ms_plotAndGains_B.error2theta;
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(977823559U, time, pData, size);
    }
  }
  ...
  /* ToAsyncQueueBlock generated from: '<Root>/plot3' */
  {
    {
      double time = simulink5ms_plotAndGains_M->Timing.t[0];
      void *pData = (void *)&simulink5ms_plotAndGains_B.error3theta;
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(1665138161U, time, pData, size);
    }
  }
  ...
  {
    {
      ...
      int32_T size = 1*sizeof(real_T);
      sendToAsyncQueueTgtAppSvc(2222341837U, time, pData, size);
    }
  }
...
RT_MODEL_simulink5ms_plotAndGains_T *simulink5ms_plotAndGains(void)
{
  ...
  rtmSetTFinal(simulink5ms_plotAndGains_M, -1);
  simulink5ms_plotAndGains_M->Timing.stepSize0 = 0.005;

  /* External mode info */
  simulink5ms_plotAndGains_M->Sizes.checksums[0] = (42782515U);
  simulink5ms_plotAndGains_M->Sizes.checksums[1] = (2799352297U);
  simulink5ms_plotAndGains_M->Sizes.checksums[2] = (2443528364U);
  simulink5ms_plotAndGains_M->Sizes.checksums[3] = (463492358U);
