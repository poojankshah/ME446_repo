...
void lab(float theta1motor,float theta2motor,float theta3motor,float *tau1,float *tau2,float *tau3, int error) {
    ...
    *tau3 = 0;
    ...
    theta2dotdot = theta2dotdot_desired + Kp2_inv*(theta2_desired - theta2motor) + Kd2_inv*(theta2dot_desired - Omega2);
    theta3dotdot = theta3dotdot_desired + Kp3_inv*(theta3_desired - theta3motor) + Kd3_inv*(theta3dot_desired - Omega3);

    *tau2 = fric_coeff_2*u_fric_2 - 0.0076*cos(theta2motor - theta3motor)*Omega3*Omega3 + 0.03*theta2dotdot - 0.738*sin(theta2motor) + 0.0076*theta3dotdot*sin(theta2motor - theta3motor);
    *tau3 = fric_coeff_3*u_fric_3 + 0.0076*cos(theta2motor - theta3motor)*Omega2*Omega2 + 0.0128*theta3dotdot - 0.2923*cos(theta3motor) + 0.0076*theta2dotdot*sin(theta2motor - theta3motor);
    ...
    Simulink_PlotVar1 = theta2_desired;
    Simulink_PlotVar2 = theta2motor;
    Simulink_PlotVar3 = theta3_desired;
